...
class Clickable extends React.Component {
  constructor(props) {
    ...
    this.attackMonsterZero = this.attackMonsterZero.bind(this);
    this.attackMonsterOne = this.attackMonsterOne.bind(this);
    this.attackMonsterTwo = this.attackMonsterTwo.bind(this);
